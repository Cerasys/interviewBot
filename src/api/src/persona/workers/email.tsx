...
export const EmailContent = ({ videoLink }: INotificationEmailProps) => {
    return (
        <div>
            <h1>Your Report Card is On the Way!</h1>
            <p>Hello,</p>
            <p>Greetings! We hope you're having a splendid day. We're reaching out to let you know that your recording session has wrapped up successfully. 🎉</p>
            <h2>Here's a quick update:</h2>
            {(videoLink) ? (
                <p>🎙 <strong>Recording Status</strong>: Complete! You can download your recording by <a href={videoLink}>clicking here</a>. If you encounter any issues, kindly contact our team, and we'll assist you.</p>
            ) : (
            ...
            <ol>
                ...
                <li>Need Assistance?: Our dedicated support team is always here to help. Whether you have questions about the report card or need assistance with the recording, please don't hesitate to reach out.</li>
            </ol>
